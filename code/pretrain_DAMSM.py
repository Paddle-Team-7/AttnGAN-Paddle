...
if __name__ == "__main__":
    ...
    dataset_val = TextDataset(cfg.DATA_DIR, 'test',
                              base_size=cfg.TREE.BASE_SIZE,
                              transform=image_transform)
    dataloader_val = paddle.io.DataLoader(
    ...
    try:
        ...
        for epoch in range(start_epoch, cfg.TRAIN.MAX_EPOCH):
            #nn.utils.clip_grad_norm(rnn_model.parameters(), cfg.TRAIN.RNN_GRAD_CLIP)
            optimizer = optim.Adam(parameters=para, learning_rate=lr, beta1=0.5, beta2=0.999, grad_clip=nn.ClipGradByNorm(cfg.TRAIN.RNN_GRAD_CLIP))
            ...
            if (epoch % cfg.TRAIN.SNAPSHOT_INTERVAL == 0 or
                ...
                paddle.save(image_encoder.state_dict(),
                           '%s/image_encoder%d.pdparams' % (model_dir, epoch))
                paddle.save(text_encoder.state_dict(),
                           '%s/text_encoder%d.pdparams' % (model_dir, epoch))
