...
class RNN_ENCODER(nn.Layer):
    def __init__(self, ntoken, ninput=300, drop_prob=0.5,
        ...
        str_bidirectional = 'bidirectional' if bidirectional else 'forward'

        self.bidirectional = str_bidirectional
...
class CA_NET(nn.Layer):
    ...
    def __init__(self):
        ...
        self.fc = nn.Linear(self.t_dim, self.c_dim * 4, bias_attr=True)
        self.relu = GLU()
...
class INIT_STAGE_G(nn.Layer):
    ...
    def define_module(self):
        ...
        self.fc = nn.Sequential(
            nn.Linear(nz, ngf * 4 * 4 * 2, bias_attr=False),
